...
#' @useDynLib processx3, .registration = TRUE, .fixes = "c_"
NULL
...
#'     used. Note that `processx3` always reencodes the output of
...
#' already finished/dead when `processx3` tried to kill it).
#'
...
process_restart <- function(self, private) {
  ...
  if (!is.null(private$status)) {
    .Call(c_processx3__disconnect_process_handle, private$status);
  }
...
process_wait <- function(self, private, timeout) {
  ...
  if (private$exited) {
    ...
    .Call(c_processx3_wait, private$status, as.integer(timeout))
  }
  invisible(self)
}
...
process_is_alive <- function(self, private) {
  ...
  if (private$exited) {
    ...
    .Call(c_processx3_is_alive, private$status)
  }
}
...
process_get_exit_status <- function(self, private) {
  ...
  if (private$exited) {
    ...
    .Call(c_processx3_get_exit_status, private$status)
  }
}
...
process_signal <- function(self, private, signal) {
  ...
  if (private$exited) {
    ...
    .Call(c_processx3_signal, private$status, as.integer(signal))
  }
}
...
process_kill <- function(self, private, grace) {
  ...
  if (private$exited) {
    ...
    .Call(c_processx3_kill, private$status, as.numeric(grace))
  }
}
...
process_get_pid <- function(self, private) {
  if (private$exited) {
    ...
    .Call(c_processx3_get_pid, private$status)
  }
}
