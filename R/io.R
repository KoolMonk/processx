...
process_read_output <- function(self, private, n) {
  ...
  .Call(c_processx3_connection_read_chars, con, n)
}
...
process_read_output_lines <- function(self, private, n) {
  ...
  con <- process_get_output_connection(self, private)
  .Call(c_processx3_connection_read_lines, con, n)
}
...
process_is_incompelete_output <- function(self, private) {
  con <- process_get_output_connection(self, private)
  ! .Call(c_processx3_connection_is_eof, con)
}
...
close.processx3_connection <- function(con, ...) {
  .Call(c_processx3_connection_close, con)
}
